...
git clone git@github.com:Coryza/baklava .
...
Don't forget to also make a [release on GitHub](https://github.com/Coryza/baklava/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.